import {
  ...
  getHorseStatisticsEntriesDetail,
  updateHorseData
} from 'api/Services'
...
/* HORSE STATISTICS ENTRIES DETAIL */

export const FETCH_HORSE_STATISTICS_ENTRIES_DETAIL = 'FETCH_HORSE_STATISTICS_ENTRIES_DETAIL'

export const RECEIVED_HORSE_STATISTICS_ENTRIES_DETAIL = 'RECEIVED_HORSE_STATISTICS_ENTRIES_DETAIL'

export const FAILED_TO_FETCH_HORSE_STATISTICS_ENTRIES_DETAIL = 'FAILED_TO_FETCH_HORSE_STATISTICS_ENTRIES_DETAIL'

export const gettingHorseStatisticsEntriesDetail = () => ({
  type: FETCH_HORSE_STATISTICS_ENTRIES_DETAIL
})

export const receivedHorseStatisticsEntriesDetail = data => ({
  type: RECEIVED_HORSE_STATISTICS_ENTRIES_DETAIL,
  data
})

export const failedToGetHorseStatisticsEntriesDetail = () => ({
  type: FAILED_TO_FETCH_HORSE_STATISTICS_ENTRIES_DETAIL
})

export const fetchHorseStatisticsEntriesDetail = (slug, meetingDate) => {
  return (dispatch, getState) => {
    return dispatch({
      type: AUTHENTICATED_REQUEST,
      types: [gettingHorseStatisticsEntriesDetail, receivedHorseStatisticsEntriesDetail, failedToGetHorseStatisticsEntriesDetail],
      endpoint: getHorseStatisticsEntriesDetail,
      urlParams: {slug, meetingDate}
    })
  }
}
