...
import ManagerDashboardMessaging from 'views/ManagerDashboard/ManagerDashboardMessaging'
      ...
      <Layout>
        <ScrollTop>
          <Switch>
            ...
            <AuthRoute path='/landing' component={LandingPage} redirectPath='/' />
            ...
            <AuthRoute path='/syndicate/:slug/manage/message' component={ManagerDashboardMessaging} redirectPath='/' />
