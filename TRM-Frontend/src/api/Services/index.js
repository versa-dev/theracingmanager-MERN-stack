...
export const performSyndicateMemeberMessageUpdate = (data, token, slug) => {
  return post({
    url: `${SERVICE_TYPES.SYNDICATE_MESSAGES}/${slug}/message`,
    headers: {
...
export const getSyndicateMembers = (token, slug) => {
  return get({
    url: `${SERVICE_TYPES.GET_SYNDICATE_MEMBERS}/${slug}/members`,
    headers: {
      'Authorization': `JWT ${token}`
    }
  })
